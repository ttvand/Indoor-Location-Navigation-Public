...
public_ids = np.sort(np.array(list(public_ids)))
private_ids = np.sort(np.array(list(private_ids)))
...
leaderboard_type.loc[public_ids, 'type'] = 'public'
leaderboard_type.loc[private_ids, 'type'] = 'private'
